...
:::python
```python A tool the agent can use to look up user information wrap
...
:::js
```typescript A tool the agent can use to look up user information wrap
import { z } from "zod";
...
:::python
```python Example of a tool that updates user information wrap
...
:::js
```typescript Example of a tool that updates user information wrap
import { z } from "zod";
