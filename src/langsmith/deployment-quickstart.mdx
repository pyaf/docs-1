...
2. Click the **Debugger** button in the top right corner. The [Debugger](/langsmith/debugger) will open to display your graph.
...
* The [Debugger overview](/langsmith/debugger)
* [Deployment options](/langsmith/deployments)
