...
1. [**Cloud**](/langsmith/cloud) - Fastest setup, fully managed (recommended)
2. [**Hybrid**](/langsmith/hybrid) - Data plane in your cloud, control plane managed by LangChain
3. [**Self-hosted**](/langsmith/self-hosted) - Full control in your infrastructure

Not sure which? See the [hosting comparison](/langsmith/hosting).

**Then deploy your app:**
- [Deploy to Cloud quickstart](/langsmith/deployment-quickstart) - 5-minute guide
