...
This guide shows you how to deploy **standalone LangGraph Servers** without the LangSmith UI or control plane. This is the most lightweight self-hosting option, ideal for running one or a few agents as independent services.

<Note>
**Is this the right guide?** This is for deploying LangGraph Servers directly without the LangSmith platform. Review the [self-hosted options](/langsmith/self-hosted) to understand:
...
Before continuing, review the [standalone server overview](/langsmith/self-hosted#standalone-server) to ensure this is the right option for you.
</Note>
