...
<Tip>
Want to see how these hooks fit into the agent execution flow? Check out the [interactive visualization in the agents documentation](/oss/javascript/langchain/agents#visualizing-agents).
</Tip>
