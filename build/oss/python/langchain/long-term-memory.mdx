...
@tool
def get_user_info(tool_runtime: ToolRuntime[Context]) -> str:
    """Look up user info."""
    # Access the store - same as that provided to `create_agent`
    store = tool_runtime.store # [!code highlight]
...
@tool
def save_user_info(user_info: UserInfo, tool_runtime: ToolRuntime[Context]) -> str:
    """Save user info."""
    # Access the store - same as that provided to `create_agent`
    store = tool_runtime.store # [!code highlight]
