...
| [Custom state](#custom-state) | Parameter name unchanged (`state_schema`), `TypedDict` only |
...
Custom state extends the default agent state with additional fields. The [`state_schema`](https://reference.langchain.com/python/langchain/middleware/#langchain.agents.middleware.AgentMiddleware.state_schema) parameter on [`create_agent`](https://reference.langchain.com/python/langchain/agents/#langchain.agents.create_agent) defines your custom state:
...
<Note>
    Custom state is defined by creating a class that extends [`AgentState`](https://reference.langchain.com/python/langchain/agents/#langchain.agents.AgentState) and passing it to [`create_agent`](https://reference.langchain.com/python/langchain/agents/#langchain.agents.create_agent)'s [`state_schema`](https://reference.langchain.com/python/langchain/middleware/#langchain.agents.middleware.AgentMiddleware.state_schema) parameter.
</Note>
