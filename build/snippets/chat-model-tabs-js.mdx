<Tabs>
    <Tab title="OpenAI">
        👉 Read the [OpenAI chat model integration docs](../integrations/chat/openai/)
    ...
    <Tab title="Anthropic">
        👉 Read the [Anthropic chat model integration docs](../integrations/chat/anthropic/)
    ...
    <Tab title="Azure">
        👉 Read the [Azure chat model integration docs](../integrations/chat/azure_chat_openai/)
    ...
    <Tab title="Google Gemini">
        👉 Read the [Google GenAI chat model integration docs](../integrations/chat/google_generative_ai/)
    ...
    <Tab title="Bedrock Converse">
        👉 Read the [AWS Bedrock chat model integration docs](../integrations/chat/bedrock_converse/)
