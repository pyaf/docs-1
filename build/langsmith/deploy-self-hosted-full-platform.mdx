---
title: Self-host LangSmith with agent deployment
sidebarTitle: With agent deployment
icon: "server"
---

Before setting up LangSmith with agent deployment, review the [self-hosting overview page](/langsmith/self-hosted#langsmith-with-agent-deployment).

<Info>
**Important**
Self-hosting LangSmith with agent deployment requires an [Enterprise](/langsmith/plans) plan.
</Info>
