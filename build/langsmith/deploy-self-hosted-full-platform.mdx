...
<Note>
**Is this the right guide?** This is for adding deployment capabilities to an existing LangSmith instance. Review the [self-hosted options](/langsmith/self-hosted) to understand:
- [LangSmith (observability only)](/langsmith/self-hosted#langsmith) - What you should install first
