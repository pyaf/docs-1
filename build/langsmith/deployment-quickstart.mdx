---
title: Deploy your first app to Cloud
sidebarTitle: Cloud quickstart
---

This is a 5-minute quickstart guide for deploying your first LangGraph application to LangSmith Cloud.

<Tip>
For a comprehensive Cloud deployment guide with all configuration options, see the [Cloud deployment setup guide](/langsmith/deploy-to-cloud).
</Tip>
...
You've successfully deployed your first application to LangSmith Cloud! Here are some next steps:
...
- **Compare hosting options**: Review [all hosting options](/langsmith/hosting) if you need Hybrid or Self-hosted
