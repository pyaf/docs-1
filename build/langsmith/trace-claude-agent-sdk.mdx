...
Install the LangSmith integration for Claude Agent SDK using `uv` or `pip`:
...
To enable LangSmith tracing for your Claude Agent SDK application, simply call `configure_claude_agent_sdk()` at the start of your application:
