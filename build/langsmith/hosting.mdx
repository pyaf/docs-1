...
This section covers how to host and manage **the LangSmith platform itself**: the infrastructure, services, and datastores that power your observability, evaluation, and agent deployment capabilities.
...
```
┌─────────────────────────────────────────┐
│   Who should manage infrastructure?     │
└─────────────────────────────────────────┘
              │
      ┌───────┴────────┐
      ↓                ↓
  LangChain           You
   ...
   Cloud         ┌─────┴──────┐
                 ↓            ↓
           Where should       All in
           data plane run?    your cloud
                 │               ↓
         ┌───────┴────────┐   Self-hosted
         ↓                ↓
    Your cloud      LangChain cloud
         ↓                ↓
      Hybrid          (See Cloud)
```
...
| **Best for** | Quick setup, managed infrastructure | Data residency requirements + managed control plane | Full control, air-gapped environments |
