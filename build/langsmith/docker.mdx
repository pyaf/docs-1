...
<Note>
**Which self-hosted option are you setting up?** This guide installs the base [LangSmith platform](/langsmith/self-hosted#langsmith) for local testing. It does **not** include deployment management features. Review the [self-hosted options](/langsmith/self-hosted) if you're unsure which you need.
</Note>
